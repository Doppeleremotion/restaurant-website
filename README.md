# restaurant-website
Interactive website for a restaurant that offers delivery and catering services in Yaoundé.

This project seeks to establish an electronic request management website for a hypothetical restaurant based in the city of Yaoundé.
The technologies used in this project shall include HTML, CSS, JavaScript and SQL.
...
- The users of the delivery system shall be the customers and delivery agents.
